...
### Панель инструментов
   ...
   - Сохранить результаты в виде текста (`.csv`, `.xlsx`, `.txt`)
...
![Методы решения](https://github.com/user-attachments/assets/e2c2eb2b-d492-4bcd-a922-35dd8d4644d1)
...
- [x] **DISPS** - конструируемый алгоритм с переменным порядком, числом стадий, с контролем точности и устойчивости.
